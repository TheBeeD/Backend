...
CREATE TABLE IF NOT EXISTS `menuiz`.`t_d_TicketSavDetail_TSD` (
  ...
  PRIMARY KEY (`TSD_ID`),
  INDEX `fk_t_d_TicketSavDetail_TSD_t_d_user_usr1_idx` (`t_d_user_usr_USR_ID` ASC, `t_d_user_usr_t_d_address_adr_ADR_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `menuiz`.`t_d_user_usr` (
  ...
  INDEX `fk_t_d_user_usr_t_d_TicketSavDetail_TSD1_idx` (`t_d_TicketSavDetail_TSD_TSD_ID` ASC) VISIBLE,
  CONSTRAINT `fk_t_d_user_usr_t_d_address_adr1`
    FOREIGN KEY (`t_d_address_adr_ADR_ID`)
    REFERENCES `menuiz`.`t_d_address_adr` (`ADR_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_t_d_user_usr_t_d_TicketSavDetail_TSD1`
...
CREATE TABLE IF NOT EXISTS `menuiz`.`T_D_HISTFOLDER_HFO` (
  ...
  `t_d_TicketSavDetail_TSD_TSD_ID` INT NOT NULL,
  INDEX `fk_T_D_HISTFOLDER_HFO_t_d_TicketSavDetail_TSD1_idx` (`t_d_TicketSavDetail_TSD_TSD_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `menuiz`.` t_d_diagSav_dsa` (
  ...
  INDEX `fk_ t_d_diagSav_dsa_t_d_TicketSavDetail_TSD1_idx` (`t_d_TicketSavDetail_TSD_TSD_ID` ASC) VISIBLE,
