...
CREATE TABLE IF NOT EXISTS `menuiz`.`t_d_user_usr` (
  ...
  INDEX `fk_t_d_user_usr_t_d_address_adr1_idx` (`t_d_address_adr_ADR_ID` ASC) ,
  INDEX `fk_t_d_user_usr_t_d_TicketSavDetail_TSD1_idx` (`t_d_TicketSavDetail_TSD_TSD_ID` ASC) ,
